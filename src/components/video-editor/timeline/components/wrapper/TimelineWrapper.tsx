	...
	return (
		...
		>
			<div className="relative h-full min-h-0">
				...
				<div
					ref={tooltipRef}
					className="absolute top-1 pointer-events-none z-[60] rounded-lg bg-[#1c1c1f] px-2.5 py-1.5 text-[12px] font-medium tabular-nums whitespace-nowrap text-white shadow-[0_8px_24px_rgba(15,23,42,0.22)]"
